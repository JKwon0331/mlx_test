...
class Dataset_mel(Dataset):
    ...
    def __init__(self, x, y, data_len = 130, train = True, dur = 60):
        self.len = x.shape[0]
    ...
    def __getitem__(self, index):
        ...
        if self.train:
            max_start = max(0, self.data_len - self.dur)
            mel_start = random.randint(0, max_start)
        
            x_data = x_data[mel_start : mel_start + self.dur,]    
            y_data = y_data[mel_start : mel_start + self.dur,]
        else:
            x_data = x_data[0:self.data_len,]
            y_data = y_data[0:self.data_len,]
